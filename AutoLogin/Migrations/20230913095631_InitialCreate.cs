    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GUIDForUser = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    ...
                    IsDelete = table.Column<bool>(type: "tinyint(1)", nullable: true, defaultValueSql: "'0'"),
                    ModificationTime = table.Column<DateTime>(type: "timestamp", nullable: true, defaultValueSql: "CURRENT_TIMESTAMP"),
                    CreationTime = table.Column<DateTime>(type: "timestamp", nullable: true, defaultValueSql: "CURRENT_TIMESTAMP"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => x.GUIDForUser);
                })
                .Annotation("MySql:CharSet", "utf8mb4")
